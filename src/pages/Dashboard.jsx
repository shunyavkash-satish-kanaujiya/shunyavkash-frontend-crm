...
import { EmployeeForm } from "../components/forms/EmployeeForm.jsx";
import { Employees } from "../components/hr/Employees.jsx";
import { EmployeeProfile } from "../components/dashboard/EmployeeProfile.jsx"; // Import the new component
...
export const Dashboard = () => {
  ...
  const renderMainContent = () => {
    if (isNestedRoute) {
      return <Outlet />; // Render nested routes (like employee profile)
    }
    switch (activeTab) {
      case TABS.DASHBOARD:
        return (
      ...
      case TABS.ADD_INVOICE:
        return <CreateInvoice setActiveTab={setActiveTab} />;

      case TABS.EMPLOYEE_DETAILS:
        return <EmployeeProfile />;

      case TABS.PAGENOTFOUND:
        return <PageNotFound setActiveTab={setActiveTab} />;
